...
class CleaningTransformer:
    ...
    def clean_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df_cleaned.dropna(subset=['customer_id', 'account_id', 'amount'])
        # Luego, filtra el dataframe para quedarte solo con las transacciones cuyo monto ('amount') sea diferente de 0.
        ...
        df_cleaned.drop(columns=['name', 'description', 'currency'], errors='ignore', inplace=True)
